 ...
 * bitmap cache of the JTattoo bumps texture and other generally useful stuff.
 *
...
final class ColorUtil {
    ...
    /**
     * Draws drag texture of given dimensions. Texture is appropriate for JTattoo
     * like view tabs
     */
    ...
    private static BufferedImage createBitmap(int height, int type,
        ...
        if (result.getAlphaRaster() == null) {
            Color c = type == FOCUS_TYPE ?
                    JTattooViewTabDisplayerUI.getActBgColor() :
                    JTattooViewTabDisplayerUI.getInactBgColor();
            g.setColor(c);
